...
export default function App() {
    ...
    return (_jsxs("div", { className: "h-full flex flex-col", children: [_jsxs("header", { className: "h-12 border-b bg-white flex items-center px-4 gap-2 shrink-0", children: [_jsx("div", { className: "font-semibold text-slate-800", children: "CargoDash WebUI" }), _jsx("div", { className: "text-xs text-slate-400", children: "v0.1 preview" }), _jsx("div", { className: "flex-1" }), _jsx("button", { onClick: onImportClick, className: "text-xs px-3 py-1.5 rounded border border-slate-300 hover:bg-slate-50", children: "Import .cdgraph.json" }), _jsx("button", { onClick: onExportJson, className: "text-xs px-3 py-1.5 rounded border border-slate-300 hover:bg-slate-50", children: "Export .cdgraph.json" }), _jsx("button", { onClick: onExportPy, className: "text-xs px-3 py-1.5 rounded bg-slate-800 text-white hover:bg-slate-700", children: "Export pipeline.py" }), _jsx("button", { onClick: reset, className: "text-xs px-2 py-1.5 rounded text-slate-500 hover:bg-slate-100", children: "Clear" }), _jsx("input", { ref: fileInputRef, type: "file", accept: ".json,application/json", className: "hidden", onChange: onImportFile })] }), _jsxs("div", { className: "flex-1 grid grid-cols-[220px_1fr_320px] min-h-0", children: [_jsx("aside", { className: "border-r bg-white min-h-0", children: _jsx(NodePalette, {}) }), _jsx("main", { className: "min-h-0", children: _jsx(Canvas, {}) }), _jsx("aside", { className: "border-l bg-white min-h-0", children: _jsx(PropertiesPanel, {}) })] })] }));
}
